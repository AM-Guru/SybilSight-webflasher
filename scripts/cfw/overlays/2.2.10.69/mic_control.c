...
#define FW_HCI_LE_SET_DATA_LEN ((hci_set_data_len_fn)0x005410EFU)
#define FW_DM_CONN_CCB         ((dm_conn_ccb_fn)0x004CA71FU)
...
#define MIC_FLAG_DLE         0x20u   /* 2.2.10.69: request LE data length 251 on the phone link */
