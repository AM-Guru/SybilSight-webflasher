...
export const POGO_TRANSFER_RESEARCH = Object.freeze({
  ...
  caseUsbBridge: Object.freeze({
    status: "hardware-validated-right",
    attempts: 7,
    ...
    validationBoundary:
      "Attempt 6 completed and verified the reviewed CFW Apollo-main transfer on the right running temple. Attempt 7 rejected the left route before transmission because its YHM baseline was not allowlisted.",
    ...
    successfulTransfer: Object.freeze({
      route: "right",
    ...
    currentSourceReviewGate: "passed-hardware-validated-right",
    declaredBytes: 2872,
    declaredSha256:
      "08a08f45ac125a1dba6469234e56cacd32147d9e79203327987276d2fb182b02",
    observedBytes: 2872,
    observedSha256:
      "08a08f45ac125a1dba6469234e56cacd32147d9e79203327987276d2fb182b02",
    hardwareAttemptsWithCurrentSource: 2,
...
export function describePogoOtaComponent(typeId, payloadSize) {
  ...
  if (typeId === 0) {
    return {
      ...
      safetyLabel: "MAIN ONLY · RIGHT CASE BRIDGE VALIDATED",
      commitBoundary:
